export const monthNames = Array.from({ length: 12 }, (x, index) =>
  new Date(0, index).toLocaleDateString("en-CA", { month: "long" })
);

export const weekdays = Array.from({ length: 7 }, (x, index) =>
  new Date(0, 0, index).toLocaleDateString("en-CA", { weekday: "long" })
);

export const monthName = month =>
  new Date(0, month).toLocaleDateString("en-CA", { month: "long" });
